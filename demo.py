...
from yolov7.detect import detect_icra_new, load_model
...
def get_and_process_data(label,cv_color, cv_depth, cfgs, model_info):
    ...
    bbox_width = p2[0] - p1[0] 
    bbox_height = p2[1] - p1[1]
    ...
    # return end_points, cloud, center_pose, bbox
    bbox = [bbox_width, bbox_height]
    return cloud, center_pose, bbox
...
def ros_demo(grasp_enable, label, cv_color, cv_depth, model_info, save_path='./top5.txt'):
    ...
    cloud ,center_pose, bbox = get_and_process_data(label, cv_color, cv_depth, cfgs, model_info)
    ...
    #     vis_grasps(gg, cloud)
    #     return rotat, trans, center_pose, bbox
    # else:
        # if end_points == None:
        #     return None
    ...
    #                         [1,0,0],
    #                         [0,0,1]])
    center_rotat = center_rotat.flatten()
    center_pose = center_pose.flatten()
    # print(center_rotat)
    # print(center_pose)
    return center_rotat, center_pose, center_pose, bbox
